(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    8823: function (e, r, a) {
      Promise.resolve().then(a.bind(a, 2479));
    },
    7907: function (e, r, a) {
      "use strict";
      var t = a(5313);
          ...
          children: [
            ...
            (0, t.jsxs)("div", {
              ...
              children: [
                (0, t.jsx)(n.default, {
                  title: "Tin tức",
                  description: "Cập Nhật C\xe1c Tin Tức Mới Nhất",
                }),
                (0, t.jsxs)("div", {
                  children: [
                    (0, t.jsx)(l.default, {}),
                    (0, t.jsx)("div", {
                      ...
                      children: (0, t.jsx)(o.default, {
                        ...
                        children: (0, t.jsxs)("button", {
                          type: "button",
                          className:
                            "focus:outline-none focus-visible:outline-0 disabled:cursor-not-allowed disabled:opacity-75 flex-shrink-0 font-medium rounded-md text-sm gap-x-1.5 px-2.5 py-1.5 text-primary-500 dark:text-primary-400 bg-primary-50 hover:bg-primary-100 disabled:bg-primary-50 dark:bg-primary-950 dark:hover:bg-primary-900 dark:disabled:bg-primary-950 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary-500 dark:focus-visible:ring-primary-400 inline-flex items-center",
                          children: [
                            (0, t.jsx)("span", {
                              className:
                                "icon-[bx--news] flex-shrink-0 h-5 w-5",
                              "aria-hidden": "true",
                            }),
                            "Xem th\xeam",
                          ],
      ...
      var o = () =>
        ...
        m = (e) => {
          ...
          return (0, t.jsx)(s.ZP, {
            ...
            defaultPerPage: 6,
            children: (e) => {
              let { data: r, isLoading: s, firstLoading: i } = e;
              return (0, t.jsxs)(t.Fragment, {
                children: [
                  (0, t.jsxs)("div", {
                    className: "grid grid-cols-12 gap-4",
                    children: [
                      !i && r && (null == r ? void 0 : r.data.length) === 0
                        ? (0, t.jsx)("div", {
